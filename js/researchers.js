...
let buildUniversityExpertElements = function(experts){
    ...
    for(var i=0; i< experts.length; i++){
        ...
        '<h5 class = "content-header-no-margin faculty-title" style="font-size:20px">'+ (expert.Q15 != ''? expert.Q15 + ',<br>':'') + (expert.Q19 != ''? expert.Q19 :'') + '</h5>' +
...
let buildNonUniversityExpertElements = function(experts){
    ...
    for(var i=0; i< experts.length; i++){
        ...
        (expert.Q111 == ''? '' : expert.Q111) + '</h5>'+ generateLogoContent(expert) +
